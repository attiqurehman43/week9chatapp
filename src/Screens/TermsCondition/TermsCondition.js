...
const TermsCondition = ({navigation}) => {
  return (
    <WrapperContainer containerStyle={{alignItems: 'center'}}>
      ...
      />
      <Text style={styles.headingStyle}>{strings.WELCOME_TO_WHATSAPP}</Text>
      <Text style={styles.descStyle}>
        {strings.READ_OUR}{' '}
        <Text style={{color: colors.lightBlue}}>{strings.PRIVACY_POLICY}</Text>{' '}
        {strings.TAP_AGREE_AND_CONTINUE_TO_CEEPT_THE}{' '}
